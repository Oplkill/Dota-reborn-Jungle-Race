...
function deb_create_enemies(  )
	...
	local unit1 = CreateUnitByName( "unit_sniper", point + RandomVector( RandomFloat( 100, 200 ) ), true, nil, nil, DOTA_TEAM_BADGUYS )
	local unit2 = CreateUnitByName( "unit_sniper", point + RandomVector( RandomFloat( 100, 200 ) ), true, nil, nil, DOTA_TEAM_BADGUYS )
	local abil = nil
	--abil = unit2:AddAbility("unvurnable_custom")
	--abil:SetLevel(1)
