...
PRE_GAME_TIME = 13.0                    -- How long after people select their heroes should the horn blow and the game start?
...
RUNE_SPAWN_TIME = 10                   -- How long in seconds should we wait between rune spawns?
...
FORCE_PICKED_HERO = "npc_dota_hero_zuus"                 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.

FIXED_RESPAWN_TIME = 9999               -- What time should we use for a fixed respawn timer?  Use -1 to keep the default dota behavior.
